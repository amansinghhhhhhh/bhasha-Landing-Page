  ...
  const TARGET_AUDIENCE = [
    {
      ...
      image: '/language-courses-new/images/indian_culture_enthusiast_1783949148707.jpg',
      icon: Globe,
    },
    {
      title: 'Working Professionals',
      description: 'Professionals working with multilingual clients or global companies.',
      image: '/language-courses-new/images/indian_working_professional_1783949166271.jpg',
      icon: Briefcase,
    },
    {
      title: 'Exam Aspirants',
      description: 'Students preparing for Goethe/TELC proficiency exams.',
      image: '/language-courses-new/images/indian_exam_aspirant_1783949182286.jpg',
      icon: BookOpen,
    },
    {
      title: 'Career Upskillers',
      description: 'Anyone looking to enhance their career with a valuable language skill.',
      image: '/language-courses-new/images/indian_career_upskiller_1783949197564.jpg',
      icon: TrendingUp,
    }
  ];
